        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-white/60 text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-8">
              ...
              technologies. Passionate about clean code and creative UI/UX
              design.
            </p>
          ...
          <div className="flex-shrink-0 relative">
            <div className="float-animation relative">
              ...
              <div className="absolute -top-2 -right-4 bg-base-200 border border-accent/20 text-accent font-display font-bold text-sm px-4 py-2 rounded-2xl shadow-lg">
                20+ Projects
              </div>
            </div>
          </div>
